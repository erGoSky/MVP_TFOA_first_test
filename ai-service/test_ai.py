...
def test_goap():
    ...
    payload = {
        ...
        "available_actions": [
            {"name": "move_to_forest", "preconditions": {"at_forest": False}, "effects": {"at_forest": True}, "cost": 1},
            {"name": "chop_wood", "preconditions": {"at_forest": True}, "effects": {"has_wood": True}, "cost": 2}
        ]
    }
    try:
