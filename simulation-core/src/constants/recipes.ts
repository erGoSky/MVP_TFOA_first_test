import { RESOURCE_TYPES, WORKSTATION_TYPES, type ResourceType, type WorkstationType } from './entities';
...
export const RECIPES: Record<string, Recipe> = {
  ...
  cloth: {
    ...
    name: 'Cloth',
    inputs: [
      { type: RESOURCE_TYPES.PLANT_FIBER, quantity: 5 },
    ],
